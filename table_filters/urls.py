"""
URL configuration for table_filters project.
...
urlpatterns = [
    ...
    path('loans-chart/', views.loans_chart, name='loans-chart'),

    path('chart', unit_station2.as_view(), name='station-chart'),
    path('api', unit_station_chart2.as_view(), name='chart2'),
#debug tool bar
